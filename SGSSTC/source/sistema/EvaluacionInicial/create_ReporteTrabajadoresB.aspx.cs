...
namespace SGSSTC.source.sistema.EvaluacionInicial
{
    public partial class create_ReporteTrabajadoresB : Page
    {
        ...
        //    Tuple<Document, PdfPTable> DocumentoPDF = ManageFiles.PdfParte1(IdEmpSuc.Item2, "ReporteTrabajadores_", "REPORTE DE TRABAJADORES", this);
        ...
        //        {
        //            DocumentoPDF = Tuple.Create(DocumentoPDF.Item1, ManageFiles.AddCelda(DocumentoPDF.Item2, 1, "H4", "C", "1|1|1|1", 5, 1, "azul", headers[PosHeader]));
        ...
        //        else if (i == 158)
        //        {
        //            DocumentoPDF = Tuple.Create(DocumentoPDF.Item1, ManageFiles.AddCelda(DocumentoPDF.Item2, 1, "H4", "L", "1|1|1|1", 5, 1, "", columna1[posicionfila / 2]));
        //            DocumentoPDF = Tuple.Create(DocumentoPDF.Item1, ManageFiles.AddCelda(DocumentoPDF.Item2, 1, "H4", "C", "1|1|1|1", 1, 1, "", lbTotalSi.Text));
        //            DocumentoPDF = Tuple.Create(DocumentoPDF.Item1, ManageFiles.AddCelda(DocumentoPDF.Item2, 1, "H4", "C", "1|1|1|1", 1, 1, "", lbTotalNo.Text));
        //            DocumentoPDF = Tuple.Create(DocumentoPDF.Item1, ManageFiles.AddCelda(DocumentoPDF.Item2, 1, "H4", "L", "1|1|1|1", 5, 1, "", lbObservaciones.Text));
        //        }
        //        else
        //        {
        //            HtmlInputRadioButton miradio1 = (HtmlInputRadioButton)form1.FindControl("radio" + (posicionfila + 1));
        //            HtmlInputRadioButton miradio2 = (HtmlInputRadioButton)form1.FindControl("radio" + (posicionfila + 2));

        //            TextBox mitextbox = (TextBox)form1.FindControl("txtf" + posicionTextbox);

        //            DocumentoPDF = Tuple.Create(DocumentoPDF.Item1, ManageFiles.AddCelda(DocumentoPDF.Item2, 1, "H4", "L", "1|1|1|1", 5, 1, "", columna1[posicionfila / 2]));
        //            DocumentoPDF = Tuple.Create(DocumentoPDF.Item1, ManageFiles.AddCelda(DocumentoPDF.Item2, 1, "H4", "C", "1|1|1|1", 1, 1, "", miradio1.Checked == true ? "X" : ""));
        //            DocumentoPDF = Tuple.Create(DocumentoPDF.Item1, ManageFiles.AddCelda(DocumentoPDF.Item2, 1, "H4", "C", "1|1|1|1", 1, 1, "", miradio2.Checked == true ? "X" : ""));
        //            DocumentoPDF = Tuple.Create(DocumentoPDF.Item1, ManageFiles.AddCelda(DocumentoPDF.Item2, 1, "H4", "L", "1|1|1|1", 5, 1, "", mitextbox.Text));
