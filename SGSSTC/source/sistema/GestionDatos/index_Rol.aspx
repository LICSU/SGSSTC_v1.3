<%@ Page Language="C#" MasterPageFile="~/source/MasterPages/Menu.Master" AutoEventWireup="true" CodeBehind="index_Rol.aspx.cs" Inherits="SGSSTC.source.sistema.GestionDatos.index_Rol" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
	...
	<asp:UpdatePanel ID="updatePanelPrinicpal" runat="server">
		<ContentTemplate>
						...
						<asp:GridView ID="GridView1" class="table table-bordered table-hover dataTable" runat="server"
							...
							<Columns>
								<asp:TemplateField HeaderText="Id Categoria" Visible="false" HeaderStyle-CssClass="text-center">
									<ItemTemplate>
										<asp:Label ID="id" runat="server" Text='<%# Eval("id_rol") %>' /></ItemTemplate>
								</asp:TemplateField>
			...
			<asp:PlaceHolder runat="server" ID="phAgregarRol">
							...
							<div class="row">
								<div class="col-md-8 col-md-offset-2">
									...
									<asp:TextBox ID="txtNombre" MaxLength="100" runat="server" ClientIDMode="Static"
										...
										title="Ingrese el nombre de el Rol"></asp:TextBox>
