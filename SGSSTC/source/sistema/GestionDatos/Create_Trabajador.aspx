                ...
                <div class="row">
                    <div class="col-md-4 col-md-offset-2">
                            ...
                            <asp:DropDownList runat="server" id="ddlDiscapacitado" CssClass="form-control" AutoPostBack="true" 
                                OnSelectedIndexChanged="ddlDiscapacitado_SelectedIndexChanged"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                            ...
                            <asp:FileUpload runat="server" id="fuFoto" 
                                data-toggle="tooltip" data-placement="bottom" title="Seleccione la foto del trabajador(a)"/>
                            
                            <asp:RequiredFieldValidator ErrorMessage="<p>Campo Obligatorio!</p>" setfocusonerror="true" 
                                Display="Dynamic" ForeColor="#B50128" Font-Size="10" Font-Bold="true" 
                                ControlToValidate="fuFoto" runat="server" ValidationGroup="ValidationAdd"/>
                        </div>
                </div>
                ...
                <div class="modal-body form-group">
                    <div class="row">
                        <div class="col-lg-12 form-group">
                            <h4><strong>Trabajador Agregado con Éxito!, Que desea hacer.? </strong></h4>
                        </div>
                        <div class="col-lg-4">
                            &nbsp;
                        </div>
                        <div class="col-lg-4">
                            <div class="col-lg-12 form-group">
                                <asp:Button runat="server" id="btnIraTrabajadores" Text="Ir al Listado" OnClick="btnSalir_Click" 
                                    ...
                                    data-toggle="tooltip" data-placement="bottom" title="Presione para ir al listado de trabajadores"></asp:Button>
                            </div>
                            <div class="col-lg-12 form-group">
                                <asp:Button runat="server" id="btnAgregarOtro" Text="Agregar Nuevo" OnClick="btnNuevo_Click" 
                                    class="btn btn-block btn-info"
                                    data-toggle="tooltip" data-placement="bottom" title="Presione para agregar un nuevo trabajador"></asp:Button>
                            </div>
