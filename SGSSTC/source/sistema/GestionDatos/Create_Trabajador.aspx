<%@ Page Language="C#" MasterPageFile="~/source/MasterPages/Menu.Master" AutoEventWireup="true" CodeBehind="Create_Trabajador.aspx.cs" Inherits="SGSSTC.source.sistema.GestionDatos.Create_Trabajador" %>
	...
	<asp:updatepanel id="MyUpdatePanel" runat="server">
		<ContentTemplate>
			...
			<div class="page-header">
				<h1 class="text-center">Agregar Trabajador</h1>
			</div>
				...
				<div class="row">
					...
					<div class="col-md-4  col-md-offset-4">
						...
						<asp:RequiredFieldValidator ErrorMessage="<p>Campo Obligatorio!</p>" setfocusonerror="true" 
							Display="Dynamic" ForeColor="#B50128" Font-Size="10" Font-Bold="true" ControlToValidate="ddlEmpresas" 
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-2">
					...
					<asp:TextBox runat="server" MaxLength="50" id="txtApellido1" CssClass="form-control" placeholder="Primer Apellido"
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-2">
					...
					<asp:DropDownList runat="server" id="ddlEstatus" CssClass="form-control" data-toggle="tooltip" 
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-2">
					...
					<asp:DropDownList runat="server" id="ddlPuestoTrabajo" data-toggle="tooltip" data-placement="bottom" 
						title="Seleccione el Puesto de Trabajo del trabajador(a)" CssClass="form-control"></asp:DropDownList>
					
					<asp:RequiredFieldValidator ErrorMessage="<p>Campo Obligatorio!</p>" setfocusonerror="true" Display="Dynamic" 
						ForeColor="#B50128" Font-Size="10" Font-Bold="true" ControlToValidate="ddlPuestoTrabajo" runat="server" 
						ValidationGroup="ValidationAdd"/>
				</div>
			...
			<div class="row">
				<div class="col-md-3 col-md-offset-1">
					...
					<asp:DropDownList runat="server" id="ddlRegion" CssClass="form-control" AutoPostBack="true" 
						...
						title="Seleccione la región donde reside el trabajador(a)"></asp:DropDownList>
				...
				<div class="col-md-4">
					...
					<asp:DropDownList runat="server" id="ddlDepartamento" CssClass="form-control" AutoPostBack="true" 
						...
						title="Seleccione el departamento donde reside el trabajador(a)"></asp:DropDownList>
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-2">
					...
					<asp:DropDownList runat="server" id="ddlDiscapacitado" CssClass="form-control" AutoPostBack="true" 
						OnSelectedIndexChanged="ddlDiscapacitado_SelectedIndexChanged" data-toggle="tooltip" data-placement="bottom"
						title="Seleccione si el trabajador(a) tiene una discapacidad">
						<asp:ListItem Text="Seleccione un Valor" Value=""></asp:ListItem>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<h4>Tipo Vinculación Laboral</h4>
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-2">
					...
					<asp:DropDownList runat="server" id="ddlCcf" CssClass="form-control" data-toggle="tooltip" 
						data-placement="bottom" 
						title="Seleccione la Caja de Compensación Familiar del trabajador(a)"></asp:DropDownList>
				...
				<div class="col-md-4">
					...
					<asp:FileUpload runat="server" id="fuFoto" data-toggle="tooltip" data-placement="bottom" 
						title="Seleccione la foto del trabajador(a)"/>
					
					<asp:RequiredFieldValidator ErrorMessage="<p>Campo Obligatorio!</p>" setfocusonerror="true" Display="Dynamic" 
						ForeColor="#B50128" Font-Size="10" Font-Bold="true" ControlToValidate="fuFoto" runat="server" 
						ValidationGroup="ValidationAdd"/>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-2 col-md-offset-5">
					<asp:Button runat="server" id="btnAceptar" Text="Aceptar" OnClick="btnAceptar_Click" 
						class="btn btn-block btn-info" ValidationGroup="ValidationAdd" data-toggle="tooltip" 
						data-placement="bottom" title="Presione para registrar el trabajador"></asp:Button>
				</div>
			</div>
