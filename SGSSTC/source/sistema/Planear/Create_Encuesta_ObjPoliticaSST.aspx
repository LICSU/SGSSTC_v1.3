                    ...
                    <table class="table table-condensed">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="lbTotalSi" runat="server" Text="---"></asp:Label></td>
                                <td>
                                    <asp:Label ID="lbTotalNo" runat="server" Text="---"></asp:Label></td>
                                <td>
                                    <asp:Label ID="lbObservaciones" runat="server" Text="---"></asp:Label></td>
                            </tr>
