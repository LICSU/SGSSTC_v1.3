                        ...
                        <asp:GridView ID="GridView1"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField Visible="false" HeaderStyle-CssClass="text-center">
                                    <ItemTemplate>
                                        <asp:Label ID="id" runat="server" Text='<%# Eval("id_ges_lab") %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                        ...
                        <div class="modal-footer">
                            <div class="row">
                                <div class="col-md-4 col-md-offset-2">
                                    <asp:Button ID="btnAddEntrega" runat="server" Text="Agregar" class="btn btn-block btn-info" OnClick="InsertarEntrega" ValidationGroup="ValidationAddEnt" />
                                </div>
                                <div class="col-md-4">
                                    <button class="btn btn-block btn-default" data-dismiss="modal" aria-hidden="true">Cerrar</button>
                                </div>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="modal-footer">
                            <div class="row">
                                <div class="col-md-4 col-md-offset-2">
                                    <asp:Button ID="btnEditar" runat="server" Text="Editar" class="btn btn-block btn-info" OnClick="btnEditarEntrega_Click" ValidationGroup="ValidationEditEnt" />
                                </div>
                                <div class="col-md-4">
                                    <button class="btn btn-block btn-default" data-dismiss="modal" aria-hidden="true">Cerrar</button>
                                </div>
