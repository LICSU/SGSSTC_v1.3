            ...
            <div class="container" style="width:100%;">
                ...
                <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <asp:RequiredFieldValidator ErrorMessage="<p>Campo Obligatorio!</p>" 
                                    setfocusonerror="true" Display="Dynamic" ForeColor="#B50128" Font-Size="10"
                                    Font-Bold="true" ControlToValidate="txtContactsSearch" runat="server" 
                                    ValidationGroup="ValidationAdd"/>
                            </div>
                            ...
                            <div class="col-md-4">
                                1) Seleccione el Nivel de escolaridad
                                ...
                                <asp:RequiredFieldValidator ErrorMessage="<p>Campo Obligatorio!</p>" 
                                    setfocusonerror="true" Display="Dynamic" ForeColor="#B50128" Font-Size="10"
                                    Font-Bold="true" ControlToValidate="rblNivel" runat="server" ValidationGroup="ValidationAdd"/>
                ...
                <div class="row">
                            ...
                            <div class="col-md-4 text-left">
                                ...
                                <asp:RequiredFieldValidator ErrorMessage="<p>Campo Obligatorio!</p>" 
                                    setfocusonerror="true" Display="Dynamic" ForeColor="#B50128" Font-Size="10"
                                    Font-Bold="true" ControlToValidate="txtAnhosApro" runat="server" ValidationGroup="ValidationAdd"/>
                ...
                <!-- Resp economica y Menores Dependen-->
                <div class="row">
                ...
                <!-- ¿Cual fue el motivo del desplazamiento?  
                ...
                <div class="row">
                            <asp:PlaceHolder id="phDesplazado" runat="server" Visible="false">
                                <div class="col-md-4 text-left">
                                    7.1) ¿Cual fue el motivo del desplazamiento?                   
                ...
                <!-- Hay Mucha Contaminación
                     Describa el techo, paredes y piso -->
                <div class="row">
                            <div class="col-md-4 text-left">
                ...
                <div class="row">
                            ...
                            <asp:RequiredFieldValidator ErrorMessage="<p>Campo Obligatorio!</p>" 
                                setfocusonerror="true" Display="Dynamic" ForeColor="#B50128" Font-Size="10"
                                Font-Bold="true" ControlToValidate="dblSeguridad" runat="server" ValidationGroup="ValidationAdd"/>
                        </div>
                            
                            <asp:PlaceHolder id="phRegimen" runat="server" Visible="false">
                                <div class="col-md-4 text-left">
                                    14.1) Régimen de Afiliación<br />
                                    <asp:RadioButtonList runat="server" id="rblRegimen" CssClass="checkbox-inline" AutoPostBack="true" 
                                    ...
                                    <asp:RequiredFieldValidator ErrorMessage="<p>Campo Obligatorio!</p>" 
                                        setfocusonerror="true" Display="Dynamic" ForeColor="#B50128" Font-Size="10"
                                        Font-Bold="true" ControlToValidate="rblRegimen" runat="server" ValidationGroup="ValidationAdd"/>
                                </div>
                            </asp:PlaceHolder>
                ...
                <!-- 16) ¿Cual es el estrato que registran sus facturas de los servicios públicos de la vivienda donde reside? -->
                <div class="row">
                            <div class="col-md-4 text-left">
                                16) ¿Cual es el estrato que registran sus facturas de los servicios públicos de la vivienda donde reside?<br />
                ...
                <div class="row" align="center">
                    ...
                    <div class="col-md-4 col-md-offset-4">
                        <asp:ImageButton id="btnGuardar" runat="server" ImageUrl="~\ico\agregar.png" OnClick="GuardarRegistro" 
                            ValidationGroup="ValidationAdd"/>
                        <h4>Guardar</h4>
                    </div>
