            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-3">
                    <asp:TextBox ID="txtBuscar" data-toggle="tooltip" data-placement="bottom" 
                        title="Ingrese Texto a Buscar" runat="server" class="form-control" PlaceHolder="Ingrese el Mapa a buscar"></asp:TextBox>
                </div>

                <div class="col-md-2">
                    <asp:Button ID="btnSearchPlan" runat="server" Text="Buscar" CssClass="btn btn-info" 
