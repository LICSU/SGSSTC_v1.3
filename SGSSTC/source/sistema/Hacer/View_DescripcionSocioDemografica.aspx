...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<div class="container" style="width: 100%;">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="col-md-6 text-left">
                    <h4 class="text-left">¡Es cabeza de familia!</h4>
                    <asp:label runat="server" id="lblCabeza" cssclass="control-label"></asp:label>
                    <hr />
                </div>
                <div class="col-md-6 text-left">
                    <h4 class="text-left">Cantidad de hijos</h4>
            ...
            <div class="col-md-12">
                <div class="col-md-6 text-left">
                    <h4 class="text-left">¿Reparte la responsabilidad económica de su familia?</h4>
            ...
            <div class="col-md-12">
                ...
                <asp:placeholder runat="server" id="phMotivoD" visible="false">
                    <div class="col-md-6 text-left">
                        <h4 class="text-left">En caso de ser desplazado, ¿Cual fue el motivo del desplazamiento?</h4>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-6 text-left">
                    <h4 class="text-left">Servicios públicos cuenta su vivienda</h4>
            ...
            <div class="col-md-12">
                <div class="col-md-6 text-left">
                    <h4 class="text-left">Su vivienda es:</h4>
                    <asp:label runat="server" id="lblVivienda2" cssclass="control-label"></asp:label>
                    <hr />
                </div>
                <div class="col-md-6 text-left">
                    <h4 class="text-left">Esta Cerca de Industrias</h4>
            ...
            <div class="col-md-12">
                <div class="col-md-6 text-left">
                    <h4 class="text-left">Describa el techo, paredes y piso:</h4>
            ...
            <div class="col-md-12">
                <asp:placeholder runat="server" id="phNivel" visible="false">
                    <div class="col-md-6 text-left">
                         <h4 class="text-left">Nivel de SISBEN
                         </h4>
            ...
            <div class="col-md-12">
                <div class="col-md-6 text-left">
                    <h4 class="text-left">Estrato que registran sus facturas de los servicios públicos de la vivienda donde reside</h4>
            ...
            <asp:placeholder runat="server" id="phEmpleos" visible="false">
                <div class="col-md-12 text-left">
                     <h4 class="text-left">18) Empleos Anteriores</h4>
                </div>
                <div class="col-md-12">
