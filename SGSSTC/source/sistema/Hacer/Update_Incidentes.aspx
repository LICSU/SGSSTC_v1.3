<%@ Page Language="C#" MasterPageFile="~/source/MasterPages/Menu.Master" AutoEventWireup="true" CodeBehind="Update_Incidentes.aspx.cs" Inherits="SGSSTC.source.sistema.Verificar.Update_Incidentes" %>
	...
	<asp:UpdatePanel ID="MyUpdatePanel" runat="server">
		<ContentTemplate>
			...
			<ol class="breadcrumb">
				...
				<li><a href="#">Editar Incidente Laboral</a></li>
			</ol>

			<div class="page-header">
				<h1 class="text-center">Actualizar Incidente Laboral</h1>
			</div>
				...
				<div class="col-md-10 col-md-offset-1">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<asp:TextBox ID="txtSitioIncidente" runat="server" TextMode="multiline" class="form-control"
								Rows="5">
							</asp:TextBox>

							<asp:RequiredFieldValidator ErrorMessage="<p>Campo Obligatorio!</p>" SetFocusOnError="true"
								Display="Dynamic" ForeColor="#B50128" Font-Size="10" Font-Bold="true"
								ControlToValidate="txtSitioIncidente" runat="server" ValidationGroup="ValidationAdd" />
						</div>
						<div class="col-md-6">
							<h4>Breve descripción de los hechos</h4>

							<asp:TextBox ID="txtDescTarea" runat="server" TextMode="multiline" Rows="5" class="form-control" MaxLength="5000"></asp:TextBox>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<asp:TextBox ID="txtCondIns" MaxLength="1000" runat="server" TextMode="multiline" Rows="3" class="form-control"
