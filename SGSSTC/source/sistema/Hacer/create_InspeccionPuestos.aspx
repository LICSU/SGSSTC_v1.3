            ...
            <asp:PlaceHolder runat="server" ID="phInformacion" Visible="False">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                                    ...
                                    <div class="panel-body">
                                        <asp:Table CssClass="table" runat="server">
                                            ...
                                            <asp:TableRow>
                                                ...
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi82" GroupName="chk79"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo82" GroupName="chk79"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                    ...
                                    <div class="panel-body">
                                        <asp:Table CssClass="table" runat="server">
                                            ...
                                            <asp:TableRow>
                                                ...
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi127" GroupName="chk127"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo127" GroupName="chk127"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt127" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                <asp:TableCell>128</asp:TableCell>
                                                <asp:TableCell>¿Se entrena al trabajador (a) para utilizar un nuevo software?</asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi128" GroupName="chk128"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo128" GroupName="chk128"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt128" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                ...
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi129" GroupName="chk129"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo129" GroupName="chk129"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt129" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                ...
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi130" GroupName="chk130"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo130" GroupName="chk130"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt130" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                ...
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi131" GroupName="chk131"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo131" GroupName="chk131"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt131" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                ...
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi132" GroupName="chk132"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo132" GroupName="chk132"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt132" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-body">
                                        <asp:Table CssClass="table" runat="server">
                                            ...
                                            <asp:TableRow>
                                                ...
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi133" GroupName="chk133"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo133" GroupName="chk133"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt133" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                ...
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi134" GroupName="chk134"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo134" GroupName="chk134"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt134" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                <asp:TableCell>135</asp:TableCell>
                                                <asp:TableCell>¿ Está señalizada la vía de Evacuación?</asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi135" GroupName="chk135"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo135" GroupName="chk135"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt135" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                <asp:TableCell>136</asp:TableCell>
                                                <asp:TableCell>¿ Existe alumbrado de Emergencia?</asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi136" GroupName="chk136"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo136" GroupName="chk136"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt136" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-body">
                                        <asp:Table CssClass="table" runat="server">
                                            ...
                                            <asp:TableRow>
                                                ...
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi137" GroupName="chk137"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo137" GroupName="chk137"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt137" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                ...
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi138" GroupName="chk138"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo138" GroupName="chk138"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt138" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                <asp:TableCell>139</asp:TableCell>
                                                <asp:TableCell>¿ Las paredes del local  son óptimas?</asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi139" GroupName="chk139"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo139" GroupName="chk139"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt139" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                <asp:TableCell>140</asp:TableCell>
                                                <asp:TableCell>¿ Las puertas se encuentran en buen estado?</asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi140" GroupName="chk140"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo140" GroupName="chk140"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt140" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                <asp:TableCell>141</asp:TableCell>
                                                <asp:TableCell>¿ Las escaleras tienen pasa manos?</asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi141" GroupName="chk141"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo141" GroupName="chk141"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt141" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                <asp:TableCell>142</asp:TableCell>
                                                <asp:TableCell>¿ las áreas están señalizadas?</asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi142" GroupName="chk142"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo142" GroupName="chk142"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt142" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                <asp:TableCell>143</asp:TableCell>
                                                <asp:TableCell>¿ El sitio de trabajo tiene la ventilación adecuada?</asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi143" GroupName="chk143"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo143" GroupName="chk143"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt143" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-body">
                                        <asp:Table CssClass="table" runat="server">
                                            ...
                                            <asp:TableRow>
                                                ...
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi144" GroupName="chk144"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo144" GroupName="chk144"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt144" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                <asp:TableCell>145</asp:TableCell>
                                                <asp:TableCell>¿Es óptimo el Estado del toma corriente?</asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi145" GroupName="chk145"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo145" GroupName="chk145"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt145" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                <asp:TableCell>146</asp:TableCell>
                                                <asp:TableCell>¿Es óptimo el Estado del Tablero eléctrico?</asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi146" GroupName="chk146"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo146" GroupName="chk146"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt146" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                <asp:TableCell>147</asp:TableCell>
                                                <asp:TableCell>¿Es óptimo el estado de los Bombillos/Tubos Fluorescentes?</asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi147" GroupName="chk147"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo147" GroupName="chk147"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt147" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-body">
                                        <asp:Table CssClass="table" runat="server">
                                            ...
                                            <asp:TableRow>
                                                ...
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi148" GroupName="chk148"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo148" GroupName="chk148"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt148" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                <asp:TableCell>149</asp:TableCell>
                                                <asp:TableCell>¿Se encuentran en estado óptimo de limpieza?</asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi149" GroupName="chk149"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo149" GroupName="chk149"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt149" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                ...
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi150" GroupName="chk150"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo150" GroupName="chk150"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt150" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                <asp:TableCell>151</asp:TableCell>
                                                <asp:TableCell>¿Los espacios sanitarios son adecuados?</asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi151" GroupName="chk151"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo151" GroupName="chk151"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt151" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                <asp:TableCell>152</asp:TableCell>
                                                <asp:TableCell>¿Existe disponibilidad de Jabón en los espacios sanitarios?</asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi152" GroupName="chk152"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo152" GroupName="chk152"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt152" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                ...
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi153" GroupName="chk153"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo153" GroupName="chk153"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt153" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                <asp:TableCell>154</asp:TableCell>
                                                <asp:TableCell>¿Existen filtros de agua potable en la empresa?</asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi154" GroupName="chk154"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo154" GroupName="chk154"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt154" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                <asp:TableCell>155</asp:TableCell>
                                                <asp:TableCell>¿Posee la empresa áreas para el descanso y la recreación?</asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi155" GroupName="chk155"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo155" GroupName="chk155"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt155" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                ...
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkSi156" GroupName="chk156"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:RadioButton runat="server" ID="chkNo156" GroupName="chk156"></asp:RadioButton></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox runat="server" ID="txt156" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                                    </div>
                                </div>
                        ...
                        <h4>Observaciones Generales: </label><br />
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <asp:Table runat="server" CssClass="table">
                                ...
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell>
                                        <asp:Label runat="server" ID="lblResultado"></asp:Label></asp:TableCell>
                                </asp:TableRow>
                            </asp:Table>
                        </div>
                    </div>
