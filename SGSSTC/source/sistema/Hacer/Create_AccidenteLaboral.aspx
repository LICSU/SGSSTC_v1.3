<%@ Page Language="C#" MasterPageFile="~/source/MasterPages/Menu.Master" AutoEventWireup="true" CodeBehind="Create_AccidenteLaboral.aspx.cs" Inherits="SGSSTC.source.sistema.Verificar.Create_AccidenteLaboral" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="MyUpdatePanel" runat="server">
        ...
        <ContentTemplate>
            ...
            <div class="row">
                <h3 class="text-center">Información del Accidente</h3>
            ...
            <div class="row">
                <h3 class="text-center">Información de la Persona Afectada</h3>
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <asp:TextBox ID="txtCondIns" runat="server" MaxLength="1000" TextMode="multiline" Rows="3"
                        class="form-control" ReadOnly="true"></asp:TextBox>

                    <br />

                    <div class="col-md-4">
                        <asp:Button runat="server" ID="btnReset" Text="Resetear Valores"
                            class="btn btn-block btn-success" OnClick="btnReset_Click"></asp:Button>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 col-md-offset-2">
                    <h5>Seleccione una Condición</h5>
                    <asp:DropDownList ID="ddlCondiciones" CssClass="form-control" runat="server" AutoPostBack="true"
                        OnSelectedIndexChanged="ddlCondicionesInseguras_SelectedIndexChanged">
                        <asp:ListItem Text="Seleccione un Valor" Value=""></asp:ListItem>
                        <asp:ListItem Text="1) Defecto de los agentes" Value="Cond1"></asp:ListItem>
                        <asp:ListItem Text="2) Riesgo de la ropa o vestuario" Value="Cond2"></asp:ListItem>
                        <asp:ListItem Text="3) Riesgos ambientales no especificados" Value="Cond3"></asp:ListItem>
                        <asp:ListItem Text="4) Métodos o procedimientos peligrosos" Value="Cond4"></asp:ListItem>
                        <asp:ListItem Text="5) Riesgo de colocación o emplazamiento" Value="Cond5"></asp:ListItem>
                        <asp:ListItem Text="6) Inadecuadamente protegido" Value="Cond6"></asp:ListItem>
                        <asp:ListItem Text="7) Riesgos ambientales en trabajos exteriores" Value="Cond7"></asp:ListItem>
                        <asp:ListItem Text="8) Riesgos públicos" Value="Cond8"></asp:ListItem>
                        <asp:ListItem Text="9) Condiciones ambientales peligrosas" Value="Cond9"></asp:ListItem>
                        <asp:ListItem Text="10) Adicional a la NTC 3701" Value="Cond10"></asp:ListItem>
                    </asp:DropDownList>
                </div>

                <asp:PlaceHolder runat="server" ID="phCond1" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phCond2" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phCond3" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phCond4" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phCond5" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phCond6" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phCond7" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phCond8" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phCond9" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phCond10" Visible="false">
                    <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <asp:TextBox ID="txtActos" runat="server" MaxLength="1000" TextMode="multiline" Rows="3"
                        class="form-control" ReadOnly="true"></asp:TextBox>
                    <br />

                    <div class="col-md-4">
                        <asp:Button runat="server" ID="btnReset2" Text="Resetear Valores"
                            class="btn btn-block btn-success" OnClick="btnReset_Click"></asp:Button>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-2">
                    <h5>Seleccione un Acto inseguro</h5>
                    <asp:DropDownList ID="ddlActoInseguro" CssClass="form-control" runat="server" AutoPostBack="true"
                        OnSelectedIndexChanged="ddlActoInseguro_SelectedIndexChanged">
                        <asp:ListItem Text="1) Bromas o juegos pesados" Value="ActIns1"></asp:ListItem>
                        <asp:ListItem Text="2) Omitir el Uso" Value="ActIns2"></asp:ListItem>
                        <asp:ListItem Text="3) No asegurar o advertir" Value="ActIns3"></asp:ListItem>
                        <asp:ListItem Text="4) Limpieza, lubricación, ajuste o reparación de equipo móvil eléctrico o de presión" Value="ActIns4"></asp:ListItem>
                        <asp:ListItem Text="5) Falta de atención a las condiciones del piso o las vecindades" Value="ActIns5"></asp:ListItem>
                        <asp:ListItem Text="6) Uso inapropiado de las manos o partes del cuerpo" Value="ActIns6"></asp:ListItem>
                        <asp:ListItem Text="7) Uso inadecuado del equipo" Value="ActIns7"></asp:ListItem>
                        <asp:ListItem Text="8) Adoptar una posición insegura" Value="ActIns8"></asp:ListItem>
                        <asp:ListItem Text="9) Operar o trabajar a velocidad insegura" Value="ActIns9"></asp:ListItem>
                        <asp:ListItem Text="10) Hacer inoperantes los dispositivos de seguridad" Value="ActIns10"></asp:ListItem>
                        <asp:ListItem Text="11) Acto subestándar no especificado en otra parte" Value="ActIns11"></asp:ListItem>
                        <asp:ListItem Text="12) Colocar, mezclar, combinar, etc., inseguramente" Value="ActIns12"></asp:ListItem>
                        <asp:ListItem Text="13) Errores de conducción" Value="ActIns13"></asp:ListItem>
                        <asp:ListItem Text="14) Usar equipo inseguro" Value="ActIns14"></asp:ListItem>
                        <asp:ListItem Text="15) Adicional a la NTC 3701" Value="ActIns15"></asp:ListItem>
                    </asp:DropDownList>
                </div>

                <asp:PlaceHolder runat="server" ID="phActIns1" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phActIns2" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phActIns3" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phActIns4" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phActIns5" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phActIns6" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phActIns7" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phActIns8" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phActIns9" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phActIns10" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phActIns11" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phActIns12" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phActIns13" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phActIns14" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phActIns15" Visible="false">
                    <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <asp:TextBox ID="txtFacTrab" runat="server" MaxLength="1000" TextMode="multiline" Rows="3"
                        class="form-control" ReadOnly="true"></asp:TextBox>
                    <br />
                    <div class="col-md-4">
                        <asp:Button runat="server" ID="btnReset3" Text="Resetear Valores"
                            class="btn btn-block btn-success" OnClick="btnReset_Click"></asp:Button>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 col-md-offset-2">
                    <h5>Seleccione un Factor de Trabajo</h5>
                    <asp:DropDownList ID="ddlFactorTrabajo" CssClass="form-control" runat="server" AutoPostBack="true"
                        OnSelectedIndexChanged="ddlFactorTrabajo_SelectedIndexChanged">

                        <asp:ListItem Text="1) Supervisión y liderazgo deficientes" Value="FacTrab1"></asp:ListItem>
                        <asp:ListItem Text="2) Ingeniería inadecuada" Value="FacTrab2"></asp:ListItem>
                        <asp:ListItem Text="3) Deficiencia en las adquisiciones / compras" Value="FacTrab3"></asp:ListItem>
                        <asp:ListItem Text="4) Mantención /mantenimiento deficiente" Value="FacTrab4"></asp:ListItem>
                        <asp:ListItem Text="5) Herramientas y equipos inadecuados" Value="FacTrab5"></asp:ListItem>
                        <asp:ListItem Text="6) Estándares deficientes de trabajo" Value="FacTrab6"></asp:ListItem>
                        <asp:ListItem Text="7) Uso y Desgaste" Value="FacTrab7"></asp:ListItem>
                        <asp:ListItem Text="8) Abuso o Maltrato" Value="FacTrab8"></asp:ListItem>
                    </asp:DropDownList>
                </div>

                <asp:PlaceHolder runat="server" ID="phFacTrab1" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phFacTrab2" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phFacTrab3" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phFacTrab4" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phFacTrab5" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phFacTrab6" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phFacTrab7" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phFacTrab8" Visible="false">
                    <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <br />
                    <div class="col-md-4">
                        <asp:Button runat="server" ID="btnReset4" Text="Resetear Valores"
                            class="btn btn-block btn-success" OnClick="btnReset_Click"></asp:Button>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 col-md-offset-2">
                    <h5>Seleccione un Factor Personal</h5>
                    <asp:DropDownList ID="ddlFactorPersonal" CssClass="form-control" runat="server" AutoPostBack="true"
                        OnSelectedIndexChanged="ddlFactorPersonal_SelectedIndexChanged">

                        <asp:ListItem Text="1) Capacidad física/fisiológica inadecuada" Value="FacPer1"></asp:ListItem>
                        <asp:ListItem Text="2) Capacidad mental/psicológica inadecuada" Value="FacPer2"></asp:ListItem>
                        <asp:ListItem Text="3) Tensión física o fisiológica" Value="FacPer3"></asp:ListItem>
                        <asp:ListItem Text="4) Tensión mental o psicológica" Value="FacPer4"></asp:ListItem>
                        <asp:ListItem Text="5) Falta de conocimiento" Value="FacPer5"></asp:ListItem>
                        <asp:ListItem Text="6) Falta de habilidad" Value="FacPer6"></asp:ListItem>
                        <asp:ListItem Text="7) Motivación deficiente" Value="FacPer7"></asp:ListItem>
                    </asp:DropDownList>
                </div>

                <asp:PlaceHolder runat="server" ID="phFacPer1" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phFacPer2" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phFacPer3" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phFacPer4" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phFacPer5" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phFacPer6" Visible="false">
                    <div class="col-md-4">
                ...
                <asp:PlaceHolder runat="server" ID="phFacPer7" Visible="false">
                    <div class="col-md-4">
            ...
            <!-- Magnitud del evento -->
            <div class="row">
                <h3 class="text-center">Magnitud del Evento</h3>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <asp:DropDownList ID="ddlTipoEnfermedad" CssClass="form-control" runat="server">
                        <asp:ListItem Text="Seleccione una Enfermedad" Value=""></asp:ListItem>
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <h3 class="text-center">Soportes fotográficos</h3>
