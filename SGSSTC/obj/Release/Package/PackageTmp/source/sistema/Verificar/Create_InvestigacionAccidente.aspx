		...
		<ContentTemplate>
            ...
            <div class="container" style="width:100%;">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="../Verificar/index_InvestigacionAccidente.aspx">Investigación de Accidente</a></li>
				...
				<div class="row">
					<div class="col-md-3">
						<h4 class="text-left">Antigüedad en el puesto:</h4> 
				...
				<div class="row">
					...
					<div class="col-md-12">
					    <h4 class="text-left">Actividad: </h4> 
				...
				<div class="row">
					<div class="col-md-3">
						<h4 class="text-left">Tipo de Accidente:</h4> 
					...
					<div class="col-md-3">
						<h4 class="text-left">Tipo de Lesión:</h4> 
					...
					<div class="col-md-3">
						<h4 class="text-left">Agente de Lesión:</h4> 
					...
					<div class="col-md-3">
						<h4 class="text-left">Parte del cuerpo afectada:</h4> 
