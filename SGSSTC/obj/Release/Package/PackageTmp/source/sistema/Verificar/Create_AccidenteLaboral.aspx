                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-md-offset-1">                   
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <h4 class="text-left">Fecha del Accidente</h4>
                            ...
                            <div class="col-md-4">
                                <h4 class="text-left">Hora del Accidente</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <asp:textbox id="txtActos" runat="server" MaxLength="1000" TextMode="multiline" Rows="3" class="form-control"
                                    readonly ="true"></asp:textbox>
                            </div>
                            <br />
                            <div class="col-md-3"> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <asp:textbox id="txtFacTrab" runat="server" MaxLength="1000" TextMode="multiline" Rows="3" class="form-control"
                                    readonly ="true"></asp:textbox>
                            </div>
                            <br />
                            <div class="col-md-3"> 
