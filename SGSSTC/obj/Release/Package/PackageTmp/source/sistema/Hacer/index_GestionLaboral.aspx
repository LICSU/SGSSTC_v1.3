    ...
    <asp:updatepanel runat="server">
        <ContentTemplate>
            ...
            <div class="page-header">
                <h1 class="text-center">Gestion Laboral</h1>
            </div>
                ...
                <asp:updatepanel runat="server">
                        <ContentTemplate>
                            <div class="modal-body form-group">
                                ...
                                <div class="row"> 
                                    <div class="col-md-6 col-md-offset-3"><asp:Button id="btnEntrega" runat="server" Text="Entrega de Equipos" class="btn btn-block btn-success" OnClick="MostrarNuevoEntrega"></asp:Button></div>
                                </div><br />
                                
                                <div class="row">
                                    <div class="col-md-6 col-md-offset-3"><asp:Button id="Button2" runat="server" Text="Capacitacion" class="btn btn-block btn-warning" OnClick="MostrarNuevoCapacitacion"></asp:Button></div>
                                </div><br />
