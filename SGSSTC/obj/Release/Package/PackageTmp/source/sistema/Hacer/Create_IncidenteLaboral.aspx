<%@ Page Language="C#" MasterPageFile="~/source/MasterPages/Menu.Master" AutoEventWireup="true" CodeBehind="Create_IncidenteLaboral.aspx.cs" Inherits="SGSSTC.source.sistema.Verificar.Create_IncidenteLaboral" %>
	...
	<asp:updatepanel id="MyUpdatePanel" runat="server">
		<ContentTemplate>
			...
			<ol class="breadcrumb">
					...
					<li><a href="#">Crear Incidente Laboral</a></li>
				</ol>

			<div class="page-header">
					<h1 class="text-center">Nuevo Incidente Laboral</h1>
				</div>
