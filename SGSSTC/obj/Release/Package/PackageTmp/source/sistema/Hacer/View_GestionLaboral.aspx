	...
	<div id="zonaPrint">
		...
		<asp:placeholder runat="server" id="phCapacitacion" visible="false">
			<div class="row">
				...
				<div class="col-md-8 text-left"><br /><h4><asp:label runat="server" text="lbEmpresa" id="lbObj"></asp:label></h4></div>
			</div>

			<div class="row">
				<div class="col-md-4 text-left"><h3>Cantidad de Horas: </h3></div>
				<div class="col-md-8 text-left"><br /><h4><asp:label runat="server" text="lbEmpresa" id="lbHoras"></asp:label></h4></div>
			</div>
			</asp:placeholder>
