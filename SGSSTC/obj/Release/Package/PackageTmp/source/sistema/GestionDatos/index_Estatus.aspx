            ...
            <div class ="container" style="width:100%;">
                ...
                <div class="row">
                    <div class="col-md-4 col-md-offset-3">
                        <asp:TextBox id="txtBuscar" data-toggle="tooltip" data-placement="bottom" title="Ingrese el texto a buscar"  runat="server" class="form-control" PlaceHolder="Ingrese el Categoria a buscar"></asp:TextBox>
                    </div>
                    ...
                    <div class="box-body">
                        <div class="dataTables_wrapper form-inline dt-bootstrap">
                            ...
                            <asp:GridView id="GridView1" 
                                class="table table-bordered table-hover dataTable" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                                PageSize="10" OnRowCommand="GridView1_RowCommand" onpageindexchanging="GridView1_PageIndexChanging"
                    ...
                    <ContentTemplate>
                        ...
                        <div class="modal-body form-group">
                            ...
                            <div class="row">
                                   ...
                                   <asp:TextBox id="txtNombreAdd" MaxLength="100" runat="server" ClientIDMode="Static" CssClass="form-control"
                                        data-toggle="tooltip" data-placement="bottom" title="Ingrese el nombre del estatus"></asp:TextBox>
                            ...
                            <div class="row">
                                    ...
                                    <asp:TextBox id="txtDescripcionAdd" MaxLength="100" TextMode="MultiLine" Rows="3" runat="server" ClientIDMode="Static" 
                                        CssClass="form-control"
                                        data-toggle="tooltip" data-placement="bottom" title="Ingrese la descripción del estatus"></asp:TextBox>
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        ...
                                        <asp:DropDownList id="ddlEmpresaEdit" 
                                            data-toggle="tooltip" data-placement="bottom" title="Seleccione una empresa" runat="server" 
