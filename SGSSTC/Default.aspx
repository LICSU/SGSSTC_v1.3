                        ...
                        <div class="col-md-7 col-sm-7 mt-text animate-box" data-animate-effect="fadeInUp" style="margin-top: 0;">
                            <style type="text/css">
                                ...
                                .table3 tbody td:nth-child(1) {
                                    ...
                                    background: -moz-linear-gradient( center bottom, #096A9F 39%, #3d9cd0) 70% );
                                    text-align: center;
                                    padding: 6px 10px;
                                    font-weight: bold;
                                    text-shadow: 1px 1px 1px #fff;
                                ...
                                .table3 tbody td:nth-child(3) {
                                    ...
                                    background: -moz-linear-gradient( center bottom, #45A8DF 39%, #bde5fb) 70% );
                                    text-shadow: 1px 1px 1px #fff;
                                }
                            </style>
                            ...
                            <div class="row">
                                ...
                                <table class="table3">
                                    <thead>
                                        <tr>
                                            <th>Plazos de<br>Cumplimiento</th>
                                            <th>Etapas</th>
                                            <th>Num Empresas</th>
                                            <th>Región<br>Central</th>
                                            <th>Región<br>SurOccidental</th>
                                            <th>Región<br>Oriental</th>
                                            <th>Región<br>Caribe</th>
                                            <th>Región<br>NorOccidental</th>
                                        </tr>
                                    </thead>
                    ...
                    <div class="owl-carousel owl-carousel-carousel">
                        ...
                        <div class="item">
                            <a target="_blank" href="http://www.mintrabajo.gov.co/febrero-2017/7749-continua-dialogo-entre-mintrabajo-y-sindicatos.html">
                                ...
                                <h4 align="justify">Continúa diálogo entre MinTrabajo y sindicatos</h4>
                            </a>
                        </div>
                        <div class="item">
